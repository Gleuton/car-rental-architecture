...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage','logging.default',
...
'boost.browser-logs','sanctum.csrf-cookie','clients.index','clients.store',
'clients.show','clients.update','clients.destroy','cars.index','cars.store',
'cars.show','cars.update','cars.destroy','rental.index','rental.store',
'rental.show','rental.update','rental.destroy','brand.index','brand.store',
'brand.show','brand.update','brand.destroy','car_model.index','car_model.store',
'car_model.show','car_model.update','car_model.destroy',
'storage.local',);
