    ...
    <nav class="mt-4">
        <ul class="pagination">
            <li class="page-item" :class="{ disabled: isFirstPage }">
                <a class="page-link" href="#" @click.prevent="loadModelList(previousPage)">Previous</a>
            </li>
            <li class="page-item" v-for="page in lastPage" :key="page">
                <a class="page-link" href="#"
                   :class="{ active: page === currentPage }"
                   @click.prevent="loadModelList(page)">
                    {{ page }}
                </a>
            </li>
            <li class="page-item" :class="{ disabled: isLastPage }">
                <a class="page-link" href="#" @click.prevent="loadModelList(nextPage)">Next</a>
            </li>
        </ul>
    </nav>
</template>
